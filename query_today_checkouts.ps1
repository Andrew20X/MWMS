...
$query = "SELECT TOP 10 a.Date, a.CheckIn, a.CheckOut, e.FirstName, e.LastName FROM Attendances a JOIN Employees e ON a.EmployeeId = e.Id WHERE a.Date = '2026-08-10' ORDER BY a.CheckIn DESC"
