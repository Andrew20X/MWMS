...
namespace MWMS.Persistence.Migrations
{
    ...
    [Migration("20260806130925_AddSubmissionComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.CorrectionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.LeaveBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EmergencyLeaveTotal")
                        .HasColumnType("int");

                    b.Property<int>("EmergencyLeaveUsed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.SubmissionComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.ApprovalHistory", b =>
                {
                    b.HasOne("MWMS.Domain.Entities.User", "Approver")
                        .WithMany()
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("MWMS.Domain.Entities.Employee", "Manager")
            ...
            modelBuilder.Entity("MWMS.Domain.Entities.LeaveRequest", b =>
                {
                    b.HasOne("MWMS.Domain.Entities.User", "ApprovedBy")
                        .WithMany()
